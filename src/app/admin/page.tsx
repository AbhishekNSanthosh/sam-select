  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        {/* Welcome banner */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#2B2B2B] to-[#1E1A14] p-6 text-white">
          ...
          <div className="relative z-10">
            <p className="text-[#D6C3A3] text-xs tracking-[0.2em] uppercase mb-1">Welcome back</p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: "Total Events", value: stats.total, icon: <Users size={18} />, color: "text-[#D6C3A3]", bg: "bg-[#D6C3A3]/10" },
            { label: "Active", value: stats.active, icon: <TrendingUp size={18} />, color: "text-emerald-600", bg: "bg-emerald-50" },
            { label: "Awaiting Review", value: stats.locked, icon: <Clock size={18} />, color: "text-amber-600", bg: "bg-amber-50" },
            { label: "Approved", value: stats.archived, icon: <CheckCircle size={18} />, color: "text-blue-600", bg: "bg-blue-50" },
          ].map((s) => (
        ...
        <div className="bg-white rounded-2xl card-shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-[#EDE7DD] flex items-center justify-between">
            <h2 className="font-display text-lg text-[#2B2B2B]">Recent Events</h2>
            <Link
              href="/admin/albums"
              className="text-sm text-[#D6C3A3] hover:underline flex items-center gap-1"
            >
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center px-4">
              ...
              <p className="font-display text-lg text-[#2B2B2B] mb-1">No events yet</p>
              <p className="text-sm text-[#6B6B6B] mb-4">Create your first event to get started.</p>
